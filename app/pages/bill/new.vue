<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-2">新增議案</h1>
      <p class="text-gray-600">依既有議案資料格式寫入 D1。</p>
    </div>
    ...
    >
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <label class="block">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 總流水號 </span>
          <input
        ...
        <label class="block md:col-span-2">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 編號 </span>
          <input
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <label class="block">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 屆內流水號 </span>
          <input v-model="form.serialNumber" type="number" min="1" class="form-input" />
        </label>

        <label class="block">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 提案時間 </span>
          <input
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <label class="block">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 提案機關/議員 </span>
        ...
        <label class="block">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 提案聯絡人姓名 </span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <label class="block">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 提案類型 </span>
          <input v-model="form.billType" type="text" class="form-input" />
        </label>

        <label class="block">
          <span class="block text-sm font-medium text-gray-700 mb-1"> 排入會議 </span>
          <input v-model="form.scheduledSession" type="text" class="form-input" />
        </label>
      </div>

      <label class="block">
        <span class="block text-sm font-medium text-gray-700 mb-1">案由</span>
        <textarea v-model="form.subject" rows="3" required class="form-textarea"></textarea>
      </label>

      <label class="block">
        <span class="block text-sm font-medium text-gray-700 mb-1">說明</span>
        <textarea v-model="form.description" rows="6" class="form-textarea"></textarea>
      </label>

      <label class="block">
        <span class="block text-sm font-medium text-gray-700 mb-1">辦法</span>
        <textarea v-model="form.proposedAction" rows="5" class="form-textarea"></textarea>
      </label>

      <label class="block">
        <span class="block text-sm font-medium text-gray-700 mb-1"> 附件 </span>
        <textarea
      ...
      >
        ...
        <NuxtLink :to="billLink" class="inline-flex mt-2 text-primary-600 hover:underline">
          查看議案
        </NuxtLink>
      </div>
